...
class MLP:
        ...
        for i in range(1, len(self.layer_sizes)):
            ...
            if i == len(self.layer_sizes) - 1:
                ...
                if self.task == 'classification':
                    ...
                    activations[f'A{i}'] = Z[f'Z{i}']  # No activation for regression
            else:
    ...
    def backward_pass(self, activations, Z, y_true):
        ...
        if self.task == 'classification':
            ...
            dz = y_pred - y_true  # For multilabel, sigmoid outputs and binary cross-entropy
        elif self.task == 'regression':
            dz = (y_pred - y_true.reshape(-1))[0]  # For regression, we use RMSE (MSE in gradient)
